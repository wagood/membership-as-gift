 ...
 * @since     0.0.1
 *
 * @property  GiftServiceService $giftService
 */
class MembershipAsGift extends Plugin
{
  // Static Properties
  // =========================================================================
   ...
   * Membershipasgift::$plugin
   *
   * @var Membershipasgift
   */
  ...
  public function init()
  {
    ...
    Event::on(
        ...
        function (RegisterComponentTypesEvent $event) {
          $event->types[] = GiftFieldField::class;
        }
    );
    ...
    Event::on(
        ...
        function (Event $event) {
          ...
          $variable->set('membershipasgift', MembershipasgiftVariable::class);
        }
    );
