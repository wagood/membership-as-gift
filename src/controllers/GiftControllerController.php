 ...
 * @since     0.0.1
 */
class GiftControllerController extends Controller
{
    ...
    {
        $result = 'Welcome to the GiftControllerController actionIndex() method';
    ...
    {
        $result = 'Welcome to the GiftControllerController actionDoSomething() method';
