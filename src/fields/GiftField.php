...
namespace wagood\membershipasgift\fields;

use wagood\membershipasgift\Membershipasgift;
use wagood\membershipasgift\assetbundles\giftfieldfield\GiftFieldFieldAsset;
...
class GiftField extends Field
{
    ...
    {
        return Craft::t('membership-as-gift', 'GiftField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'membership-as-gift/_components/fields/GiftField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(GiftFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').MembershipasgiftGiftField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'membership-as-gift/_components/fields/GiftField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
